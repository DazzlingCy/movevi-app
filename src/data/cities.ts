...
export const CITIES: CityData[] = [
  ...
  { id: '13', name: '曼谷', englishName: 'Bangkok', continent: '亚洲其他', x: 76.8, y: 45.2, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Wat_Arun_Bangkok_Thailand.jpg/1280px-Wat_Arun_Bangkok_Thailand.jpg', routes: 3, spots: 72, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'bottom', description: '湄南河畔的金色寺塔、夜市烟火与热带街巷交织，跑进曼谷的水岸记忆与城市脉搏。' },
  { id: '14', name: '孟买', englishName: 'Mumbai', continent: '亚洲其他', x: 70.8, y: 41.2, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Gateway_of_India_%28cropped%29.jpg/1280px-Gateway_of_India_%28cropped%29.jpg', routes: 3, spots: 88, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'left', description: '阿拉伯海风掠过印度门与滨海大道，孟买在殖民建筑、电影梦与市井奔流中闪光。' },
  { id: '15', name: '新加坡', englishName: 'Singapore', continent: '亚洲其他', x: 78.4, y: 51.2, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Marina_Bay_Sands_in_the_evening_-_20101120.jpg/1280px-Marina_Bay_Sands_in_the_evening_-_20101120.jpg', routes: 3, spots: 65, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'right', description: '滨海湾的天际线、花园城市的绿意与海港节奏交汇，跑过一座精密而鲜活的热带都会。' },
  { id: '16', name: '莫斯科', englishName: 'Moscow', continent: '欧洲', x: 59.5, y: 19.4, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Moscow_July_2011-7a.jpg/1280px-Moscow_July_2011-7a.jpg', routes: 3, spots: 96, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'top', description: '红场的砖红色回声、教堂穹顶与莫斯科河的冷冽光影，组成北方古都的厚重路线。' },
  { id: '17', name: '洛杉矶', englishName: 'Los Angeles', continent: '北美洲', x: 18.2, y: 34.8, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Los_Angeles%2C_Winter_2016.jpg/1280px-Los_Angeles%2C_Winter_2016.jpg', routes: 3, spots: 105, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'bottom', description: '从好莱坞山到太平洋海岸，洛杉矶把电影光影、棕榈大道与自由奔跑写进城市记忆。' },
];
