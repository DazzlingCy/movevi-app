...
export const CITIES: CityData[] = [
  ...
  { id: '15', name: '新加坡', englishName: 'Singapore', continent: '亚洲其他', x: 78.4, y: 51.2, image: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?auto=format&fit=crop&q=80&w=1200', routes: 3, spots: 65, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'right', description: '滨海湾的天际线、花园城市的绿意与海港节奏交汇，跑过一座精密而鲜活的热带都会。' },
